...
test.describe('[UI] QE-910: Role Posting Hidden for Partner Level', { tag: ['@regression', '@core-ask'] }, () => {
  let loginPage;
  let coreAskPage;

  test('[TC-1092] Verify Role Posting field is hidden when Partner is selected', async ({ page }) => {
    ...
    // Step 3: Select Partner from Level Needed
