...
test.describe('[UI] QE-910: Succession - Retirement Date Date Picker', { tag: ['@regression', '@core-ask'] }, () => {
  let loginPage;
  let coreAskPage;

  test('[TC-1113] Verify Retirement Date displays date picker for Succession', async ({ page }) => {
    ...
    // Step 7: Select date
    await coreAskPage.selectRetirementDate('06/30/2025');
