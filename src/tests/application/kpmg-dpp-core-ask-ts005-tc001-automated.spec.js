...
test.describe('[UI] QE-910 TS-005: Role Posting Field Visibility for Partner', { tag: ['@regression', '@kpmg-dpp'] }, () => {
  let coreAskPage;

  test('[QE-910 TS-005 TC-001] Verify Role Posting field is not displayed when Level Needed = Partner', async ({ page }) => {
    ...
    // Step 4: Select 'Partner' from Level Needed dropdown
    await coreAskPage.selectLevelNeeded(TD.levelNeededOptions.partner);
