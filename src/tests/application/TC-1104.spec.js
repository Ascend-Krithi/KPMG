...
test.describe('[UI] QE-910: Addition - Outgoing Resource Auto-populated N/A', { tag: ['@regression', '@core-ask'] }, () => {
  let loginPage;
  let coreAskPage;

  test('[TC-1104] Verify Outgoing Resource is auto-populated with N/A and read-only for Addition', async ({ page }) => {
